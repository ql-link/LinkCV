...
| 插件发布与下载 | `modules/plugin_releases/`、`core/storage.py` | JD 安装入口、管理台、MinIO、浏览器插件构建 | `docs/api/http-contracts.md`、`docs/internals/backend.md`、`docs/internals/extension.md` |
