-- Seed four reviewed professional resume templates.
-- Stable-key conflicts abort instead of overwriting locally customized rows.
INSERT INTO resume_templates (`key`, name, description, data_json, style_json, is_active) VALUES
(
  'administrative-sidebar-cn', '深蓝行政双栏',
  '贯穿整页的深蓝信息侧栏与清晰主内容区，适合行政、人事和综合职能岗位。',
  JSON_OBJECT(
    'schema_version', '1.0',
    'basics', JSON_OBJECT('name', '张三', 'headline', '行政专员', 'email', 'zhangsan@example.com', 'phone', '13800000000', 'location', '上海', 'summary', NULL, 'links', JSON_ARRAY()),
...
::::'), 'source_refs', JSON_ARRAY()
  ...
  JSON_OBJECT('schema_version', '1.0', 'template_key', 'administrative-sidebar-cn', 'font_family', 'source-han-serif', 'font_size', 10, 'line_height', 1.42, 'accent_color', '#294f73', 'smart_one_page', TRUE, 'page', JSON_OBJECT('size', 'A4', 'margin_top_mm', 0, 'margin_right_mm', 0, 'margin_bottom_mm', 0, 'margin_left_mm', 0), 'section_order', JSON_ARRAY('basics', 'custom_sections')), 1
),
(
  'campus-professional-cn', '校招 / 社招通用',
  '白底高信息密度、蓝色折角标题与四列经历信息，适合校招、运营和通用职能岗位。',
  JSON_OBJECT(
    'schema_version', '1.0',
    'basics', JSON_OBJECT('name', '张三', 'headline', '运营专员', 'email', 'zhangsan@example.com', 'phone', '13800000000', 'location', '杭州', 'summary', NULL, 'links', JSON_ARRAY()),
    'sections', JSON_OBJECT('custom_sections', JSON_ARRAY(JSON_OBJECT(
      'id', 'custom_section_editor', 'title', '简历正文', 'items', JSON_ARRAY(JSON_OBJECT(
        'id', 'custom_item_editor', 'title', NULL, 'subtitle', NULL,
...
- **工具：** Excel、PowerPoint、Photoshop、SPSS、XMind、Visio。'), 'source_refs', JSON_ARRAY()
      ))
    )))
  ),
  JSON_OBJECT('schema_version', '1.0', 'template_key', 'campus-professional-cn', 'font_family', 'source-han-serif', 'font_size', 9.4, 'line_height', 1.38, 'accent_color', '#4f8df7', 'smart_one_page', TRUE, 'page', JSON_OBJECT('size', 'A4', 'margin_top_mm', 8, 'margin_right_mm', 9, 'margin_bottom_mm', 8, 'margin_left_mm', 9), 'section_order', JSON_ARRAY('basics', 'custom_sections')), 1
),
(
  'civic-service-cn', '蓝色政务行政',
  '大面积蓝色页眉与稳重折角分区，适合行政事务、公共服务和社会实践岗位。',
  JSON_OBJECT(
    'schema_version', '1.0',
    'basics', JSON_OBJECT('name', '张三', 'headline', '行政事务专员', 'email', 'zhangsan@example.com', 'phone', '13800000000', 'location', '南昌', 'summary', NULL, 'links', JSON_ARRAY()),
    'sections', JSON_OBJECT('custom_sections', JSON_ARRAY(JSON_OBJECT(
      'id', 'custom_section_editor', 'title', '简历正文', 'items', JSON_ARRAY(JSON_OBJECT(
        'id', 'custom_item_editor', 'title', NULL, 'subtitle', NULL,
...
感谢您阅读这份简历，期待有机会进一步交流。'), 'source_refs', JSON_ARRAY()
      ))
    )))
  ),
  JSON_OBJECT('schema_version', '1.0', 'template_key', 'civic-service-cn', 'font_family', 'source-han-serif', 'font_size', 9.7, 'line_height', 1.45, 'accent_color', '#3476d2', 'smart_one_page', TRUE, 'page', JSON_OBJECT('size', 'A4', 'margin_top_mm', 0, 'margin_right_mm', 10, 'margin_bottom_mm', 8, 'margin_left_mm', 10), 'section_order', JSON_ARRAY('basics', 'custom_sections')), 1
),
(
  'creative-orange-cn', '橙弧创意设计',
  '橙色弧形页眉、圆形头像与三列技能信息，适合 UI、视觉和创意设计岗位。',
  JSON_OBJECT(
    'schema_version', '1.0',
    'basics', JSON_OBJECT('name', '张三', 'headline', 'UI 设计师', 'email', 'zhangsan@example.com', 'phone', '13800000000', 'location', '杭州', 'summary', NULL, 'links', JSON_ARRAY()),
    'sections', JSON_OBJECT('custom_sections', JSON_ARRAY(JSON_OBJECT(
      'id', 'custom_section_editor', 'title', '简历正文', 'items', JSON_ARRAY(JSON_OBJECT(
        'id', 'custom_item_editor', 'title', NULL, 'subtitle', NULL,
...
热爱视觉与交互设计，能够从业务目标和用户任务出发组织信息；重视设计规范、交付细节与团队协作，善于通过反馈和数据持续迭代。'), 'source_refs', JSON_ARRAY()
      ))
    )))
  ),
  JSON_OBJECT('schema_version', '1.0', 'template_key', 'creative-orange-cn', 'font_family', 'source-han-serif', 'font_size', 9.6, 'line_height', 1.4, 'accent_color', '#ff8a00', 'smart_one_page', TRUE, 'page', JSON_OBJECT('size', 'A4', 'margin_top_mm', 0, 'margin_right_mm', 10, 'margin_bottom_mm', 8, 'margin_left_mm', 10), 'section_order', JSON_ARRAY('basics', 'custom_sections')), 1
)
