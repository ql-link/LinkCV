...
from linkresume.modules.identity.dependencies import (
    get_current_admin,
    get_current_user,
    get_settings,
)
from linkresume.modules.identity.models import User
from linkresume.modules.observability.audit import AUDIT_ACTION_NAMES_WITH_CLIENT
from linkresume.modules.observability.logging import StructuredLogEmitter
from linkresume.modules.observability.loki import (
    InvalidLogCursorError,
    LokiClient,
    LokiUnavailableError,
)
from linkresume.modules.observability.schemas import (
    AcceptedResponse,
    AuditEventRequest,
