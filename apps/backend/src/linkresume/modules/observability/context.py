...
_request_id: ContextVar[str | None] = ContextVar("linkresume_request_id", default=None)
_task_id: ContextVar[str | None] = ContextVar("linkresume_task_id", default=None)
_operation_id: ContextVar[str | None] = ContextVar(
    "linkresume_operation_id", default=None
)
