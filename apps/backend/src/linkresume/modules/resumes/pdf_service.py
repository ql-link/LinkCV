...
from linkresume.core.config import REPO_ROOT, Settings
from linkresume.core.errors import ApiError
from linkresume.core.storage import AssetStorage, infer_image_content_type
...
class ResumePdfRenderer:
    ...
    def _environment(self) -> dict[str, str]:
        ...
        if self._runtime_user_available():
            environment["HOME"] = "/var/lib/linkresume-pdf"
            environment["TMPDIR"] = "/tmp/linkresume-pdf"
        else:
    ...
    def _command(cls, script: Path) -> list[str]:
        ...
        return ["runuser", "-u", "linkresume-pdf", "--", "node", str(script)]
