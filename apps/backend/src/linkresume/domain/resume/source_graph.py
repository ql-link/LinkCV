...
from linkresume.domain.resume.models import BoundingBox, SourceGraph, SourceLeaf
...
class ParsedSourceBlock:
    """Provider-neutral block accepted by the LinkResume SourceGraph boundary."""
...
def stable_source_id(
    *, source_document_sha256: str, ordinal: int, block: ParsedSourceBlock
    ...
    """Create the v1 LinkResume identity; provider ids never escape this boundary."""
