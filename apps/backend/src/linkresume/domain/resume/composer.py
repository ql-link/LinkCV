...
* :class:`~linkresume.domain.resume.models.SourceGraph` is the complete, ordered
  source inventory owned by LinkResume; and
* :class:`~linkresume.domain.resume.models.SparseResumeAnnotations` is an
