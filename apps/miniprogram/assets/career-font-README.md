...
`career-font.wxss` 内嵌 Figma 使用的 LXGW WenKai TC Regular / Bold 的 WOFF2 字符子集，CSS 家族名为 `LinkResume Career UI`。字体来源为 Google Fonts 的 `ofl/lxgwwenkaitc/LXGWWenKaiTC-Regular.ttf` 和 `LXGWWenKaiTC-Bold.ttf`：
