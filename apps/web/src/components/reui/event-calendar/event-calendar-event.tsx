...
function EventCalendarEvent<TData = unknown>({
  ...
  const defaultProps = {
    ...
    "data-read-only": event.readOnly || undefined,
    "data-draggable": (!event.readOnly && event.draggable !== false) || undefined,
    "data-resizable": (!event.readOnly && event.resizable !== false) || undefined,
