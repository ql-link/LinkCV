...
function ScheduleView({
  ...
  }, [draftColor, draftEndAt, draftStartAt, granularity, visibleInterviews]);
  ...
  const calendarComponents = useMemo(
    () => ({ week: InterviewScheduleWeekView, month: InterviewScheduleMonthView }),
    [],
  );
