...
import { api, type CanonicalResumePresentation, type ResumeVersion } from "../../api/client";
...
export function compareVersionStyles(current: ResumeSettings, historical: CanonicalResumePresentation): StyleDifference[] {
